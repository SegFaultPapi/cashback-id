...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-border bg-card/80 backdrop-blur-md shadow-lg flex justify-center space-x-4 px-8 py-6"
    >
      {children}
    </nav>
  )
  ...
  return (
    <Link href={href} className="flex space-x-2 group">
      <Image
        ...
        height={70}
        alt={title}
        className="flex-shrink-0 rounded-md shadow-md group-hover:shadow-lg transition-shadow"
      />
      <div>
